<script>
  import { IconBeer, IconBeerFilled, IconBrandFacebook, IconBrandInstagram, IconBrandYoutube, IconBuildingCastle, IconHome, IconMenu2, IconNews, IconX } from "@tabler/icons-svelte";
...
<!-- Desktop Sidebar -->
<aside class="hidden md:flex flex-col self-start gap-10 w-72 p-5 border border-zinc-800 rounded-md">
    <Menu title="Browse">
  ...
  <div class="fixed inset-0 z-50 flex justify-end" role="presentation">
    ...
    >
      <div class="flex justify-end">
        <button type="button" class="text-zinc-200" aria-label="Close menu" on:click={close}>
          <IconX />
        </button>
      </div>    
        <Menu title="Browse">
